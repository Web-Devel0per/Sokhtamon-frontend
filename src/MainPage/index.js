...
const Main = () => {
  ...
  const fetchProducts = () =>{
    axios.get("https://sokhtamon-backend-production-874c.up.railway.app/api/post/all")
    .then((res)=>{
    setPosts(res.data)
    }).catch((err)=>{
      console.log(err)
  ...
  const ad = (data) => {
    axios
      .get(
        "https://sokhtamon-backend-production-874c.up.railway.app/api/post/fetch?category_name=" +
          data
      )
      .then((res) => {
